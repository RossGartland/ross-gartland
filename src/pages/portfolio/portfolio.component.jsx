...
const Portfolio = () => {
    return (
        <div id="portfolio" className="portfolio-container">
            <div className="row">
            <PortfolioCard link={`https://covid-19ireland.com/#/`} image={covidProject} title={`Covid-19 Ireland`} about={`A website that tracks Covid-19 across the island of Ireland.`} 
